<script>
    ...
    const singInWith = async (provider) => {
        try {
...
<form class="form">
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="text" class="input" placeholder="Enter your Email" bind:value={email}>
      </div>
    ...
    <button on:click={login} class="button-submit">Sign In</button>
    <p class="p">Don't have an account? <span class="span">Sign Up</span>

    </p><p class="p line">Or With</p>

    <div class="flex-row">
      <button class="btn google" on:click={() => {singInWith(googleProvider)}}>
...
<path style="fill:#F14336;" d="M419.404,58.936l-82.933,67.896c-23.335-14.586-50.919-23.012-80.471-23.012
	...
	C318.115,0,375.068,22.126,419.404,58.936z"></path>
      ...
      </button><button class="btn apple" on:click={() => {singInWith(appleProvider)}}>
